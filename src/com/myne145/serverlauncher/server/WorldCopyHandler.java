...
//    }
    ...
    public static void copyDirectoryWithProgressBar(File sourceDir, File destDir) throws IOException {
...
//                int progress = (int) Math.round((double) copiedBytes / totalBytes * 100); //TODO: reimplement the progress bar
